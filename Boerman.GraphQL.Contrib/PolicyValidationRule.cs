...
namespace SkyHop.Hosting.Graph.Modules.Authorization
{
    public class PolicyValidationRule : IValidationRule
    {
            ...
            OperationType operationType)
        {
            ...
            var authorizationPolicy = type.GetPolicy();

            if (authorizationPolicy == null) return;

            var result = await _authorizationService.AuthorizeAsync(_httpContextAccessor.HttpContext.User, authorizationPolicy);
